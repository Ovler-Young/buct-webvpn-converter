  ...
  return (
    <div className="w-full max-w-3xl space-y-4">
      ...
      <div className="relative">
        ...
        <div className="absolute -rotate-12 -top-10 right-0 md:right-10 text-4xl font-nanum">for BIT&BUCT</div>
      </div>

      <p className="text-center leading-2 py-4 lg:leading-6 text-gray-400">
        <span className="hidden md:block">
          Convert BIT/BUCT local network URLs into Web VPN URLs. <br />
        </span>
        <span>Connect to your local networks in BIT/BUCT from anywhere in the world.</span>
      </p>
